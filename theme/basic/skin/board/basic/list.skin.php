...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <!-- 게시판 페이지 정보 및 버튼 시작 { -->
    <div class="bo_btn_tops" id="bo_btn_top">
      <div class="bo_lists">
        <ul>
          <li style="border-left: solid 2px deeppink;"><a href="<?php echo G5_BBS_URL; ?>/board.php?bo_table=notice">공지사항</a></li>
          ...
          <li><a href="<?php echo G5_BBS_URL; ?>/board.php?bo_table=attendance">출석체크</a></li>
        </ul>
      </div>
...
<ins class="adsbygoogle"
     style="display:block"
     data-ad-client="ca-pub-2760169272475121"
     data-ad-slot="5522648552"
     data-ad-format="auto"
