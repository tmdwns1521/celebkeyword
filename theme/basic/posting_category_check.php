...
if (G5_IS_MOBILE) {
    include_once(G5_THEME_MOBILE_PATH.'/posting_category_check.php');
    return;
}
if (G5_IS_MOBILE) {
 ...
 <div id="loading">
  ...
  <div id='containers'>
    <div class="container">
          ...
          <form method="post" action="<?php echo G5_URL; ?>/posting_category_check.php" id="next">
            <table>
            ...
            if(empty($_POST['stx'])){
              ...
              if(isset($_POST['stx'])){
                ...
                function blog_file_check($url) {
                  ...
                  $url = ('https://m.blog.naver.com/rego/CategoryList.nhn?blogId=celkey');
                  ...
                  $html->load($str);
                  $tag_post = $html->find('div[class="itemfont cm-col1');
