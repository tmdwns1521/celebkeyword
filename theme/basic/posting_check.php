...
if (G5_IS_MOBILE) {
    include_once(G5_THEME_MOBILE_PATH.'/posting_check.php');
    return;
}
if (G5_IS_MOBILE) {
...
if ($member['mb_level'] <= 3){
  alert("상담톡을 이용해 주세요!", G5_BBS_URL."/board.php?bo_table=free");
}
  ...
  <div id='containers'>
    <div class="container">
        ...
        <div class="posting_checklist" id="posting_ch">
          ...
          <form method="post" action="<?php echo G5_URL; ?>/posting_check.php" id="next">
            <table>
          ...
          <div class="row">
            ...
            if(empty($_POST['stx'])){
                  ...
                  echo '</div>';
                      echo '<div class="card-body">';
                        echo '<div id="relation_keyword" class="row no-gutters align-items-center">';
                          ...
                          echo '<thead><tr style="border-bottom: solid 1px;"><td>번호</td><td>포스팅 제목</td><td>포스팅 시간</td><td>포스팅 글자수</td><td>포스팅 노출</td><td>이미지 노출</td><td>분석 키워드</td><td>PC 검색량</td><td>MOBILE 검색량</td><td>VIEW 노출</td><td>블로그 노출</td><td>#태그 분석</td></tr></thead>';
                          echo '<tbody>';
                          $lo_num = 0;
                          $log_arrays = [];
                          $t_arrays = [];
                          ...
                          while (1){
                            ...
                            foreach($log_arrays as $logs){
                                ...
                                echo '<td><div class="';?><?php echo $lo_num; ?><?php echo "_"; ?><?php echo $lo_num; ?><?php echo '"></div></td>';
                                echo '<td><div class="';?><?php echo $lo_num; ?><?php echo "_"; ?><?php echo $lo_num; ?><?php echo "_"; ?><?php echo $lo_num; ?><?php echo '"></div></td>';
             ...
             function tableCreate(){
               ...
               if (level <= 3){
                 alert("고객센터에 문의 해주세요.");
                  ...
                  $.ajax({
                    url: "http://celebkeyword.com/theme/basic/posting_check_more.php",
                    type: "post",
                    dataType:'json',
             ...
             <script>
                ...
                var pc_ken = '.'+count+'_'+count;
                var mobile_ken = '.'+count+"_"+count+'_'+count;
             		$.ajax({
