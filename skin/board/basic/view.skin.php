...
<article id="bo_v" style="width:<?php echo $width; ?>; padding-left:4%; padding-right:4%;">
    <header>
        <h2 id="bo_v_title">
    ...
    <section id="bo_v_info">
        ...
        <div class="profile_info">
        	...
        	<div class="profile_info_ct">
        		<span class="sound_only">작성자</span> <strong><?php echo $view['name'] ?><?php if ($is_ip_view) { echo ""; } ?></strong>
	    ...
	    <div id="bo_v_top">
	        ...
	        <ul class="btn_bo_user bo_v_com">
	            ...
	            <?php if ($reply_href) { ?><li><a href="<?php echo $reply_href ?>" class="btn_b01 btn" title="답변"><i class="fas fa-comment" aria-hidden="true"></i><span class="sound_only">답변</span></a></li><?php } ?>
